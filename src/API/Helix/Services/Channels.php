...
class Channels extends Service
{
    ...
    const SCOPES = ['channel:manage:broadcast', 'channel:edit:commercial'];
    ...
    /**
     * @deprecated
     * @see Ads::startCommercial
     */
    public function startCommercial($usernameOrId, int $length, $authenticationChannel = null)
    {
        $adsService = $this->helix->getService(Ads::SERVICE_NAME);
        return $adsService->startCommercial($usernameOrId, $length, $authenticationChannel);
    }
}